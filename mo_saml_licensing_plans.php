                        ...
                        <li data-type="singlesite" class="mosslp is-visible" style="border: <?php echo $sseborder; ?>">
                            ...
                            <div class="cd-pricing-body">
                                <ul class="cd-pricing-features ">
                                    ...
                                    <li>Multi-Network SSO Support</li>
                                    <li>Custom AD-Server ****<br/><a style="color:blue;" href="<?php echo add_query_arg( array( 'tab' => 'support' ), htmlentities( $_SERVER['REQUEST_URI'] ) ); ?>"><b>Contact us</b></a></li>
                                    <li><b>Add-Ons</b><br />
                                         SSO Login Audit Add-On
                                
                                    &nbsp;<br />Purchase Separately<br /><a style="color:blue;" href="<?php echo add_query_arg( array( 'tab' => 'support' ), htmlentities( $_SERVER['REQUEST_URI'] ) ); ?>"><b>Contact us</b></a><br />&nbsp;&nbsp;</li>
